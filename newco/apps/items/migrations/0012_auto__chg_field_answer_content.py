...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('items_answer', 'content', self.gf('django.db.models.fields.CharField')(max_length=10000))

    def backwards(self, orm):

        # Changing field 'Answer.content'
        db.alter_column('items_answer', 'content', self.gf('django.db.models.fields.CharField')(max_length=1000))
