...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeatureP'
        db.create_table('items_featurep', (
        ...
        db.send_create_signal('items', ['FeatureP'])

        # Adding M2M table for field items on 'FeatureP'
        db.create_table('items_featurep_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('featurep', models.ForeignKey(orm['items.featurep'], null=False)),
            ('item', models.ForeignKey(orm['items.item'], null=False))
        ))
        db.create_unique('items_featurep_items', ['featurep_id', 'item_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FeatureP'
        db.delete_table('items_featurep')

        # Removing M2M table for field items on 'FeatureP'
        db.delete_table('items_featurep_items')
