...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('items_item', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.height'
        db.add_column('items_item', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.description'
        db.add_column('items_item', 'description',
                      self.gf('django.db.models.fields.CharField')(default='petite description', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.weight'
        db.delete_column('items_item', 'weight')

        # Deleting field 'Item.height'
        db.delete_column('items_item', 'height')

        # Deleting field 'Item.description'
        db.delete_column('items_item', 'description')
    ...
    models = {
        ...
        'items.externallink': {
            'Meta': {'ordering': "['-pub_date']", 'object_name': 'ExternalLink', '_ormbases': ['items.Content']},
        ...
        'items.item': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "'petite description'", 'max_length': '500'}),
