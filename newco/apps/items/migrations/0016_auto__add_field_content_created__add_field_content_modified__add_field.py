...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('items_content', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Content.modified'
        db.add_column('items_content', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Item.created'
        db.add_column('items_item', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Item.modified'
        db.add_column('items_item', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('items_content', 'created')

        # Deleting field 'Content.modified'
        db.delete_column('items_content', 'modified')

        # Deleting field 'Item.created'
        db.delete_column('items_item', 'created')

        # Deleting field 'Item.modified'
        db.delete_column('items_item', 'modified')
