...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'ExternalLink' to 'Link'
        db.rename_table('items_externallink', 'items_link')

    def backwards(self, orm):
        # Renaming model 'Link' to 'ExternalLink'
        db.rename_table('items_link', 'items_externallink')
