...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='a', max_length=50),
                      keep_default=False)


        # Changing field 'Profile.name'
        db.alter_column('profiles_profile', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    def backwards(self, orm):
        ...
        # Changing field 'Profile.name'
        db.alter_column('profiles_profile', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    models = {
        'auth.group': {
