...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.url'
        db.alter_column('affiliation_store', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'AffiliationItem.url'
        db.alter_column('affiliation_affiliationitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
    def backwards(self, orm):

        # Changing field 'Store.url'
        db.alter_column('affiliation_store', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AffiliationItem.url'
        db.alter_column('affiliation_affiliationitem', 'url', self.gf('django.db.models.fields.CharField')(max_length=400))
    models = {
