...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('affiliation_affiliationitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=800))
    ...
    models = {
        'affiliation.affiliationitem': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'max_length': '800'})
        },
