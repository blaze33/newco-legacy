...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AffiliationItem', fields ['store', 'object_id']
        db.create_unique('affiliation_affiliationitem', ['store_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AffiliationItem', fields ['store', 'object_id']
        db.delete_unique('affiliation_affiliationitem', ['store_id', 'object_id'])
