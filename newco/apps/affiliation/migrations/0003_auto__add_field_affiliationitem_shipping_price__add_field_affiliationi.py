...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'AffiliationItem.shipping_price'
        db.delete_column('affiliation_affiliationitem', 'shipping_price')

        # Deleting field 'AffiliationItem.availability'
        db.delete_column('affiliation_affiliationitem', 'availability')
